...
class TestQALoopHelpers:
    ...
    def test_truncate_context_for_tokens_short_context(self):
        ...
        result = truncate_context_for_tokens(context_chain, 1000)
    ...
    def test_truncate_context_for_tokens_long_context(self):
        ...
        result = truncate_context_for_tokens(context_chain, 100)
        
        # Should include the most recent entry
        assert "[assistant:question] Short response" in result
            ...
            "candidates": [
                {
                    "content": {
                        "parts": [
                            {
                                "text": '{"question": "What genre?", "options": ["Fantasy", "Sci-Fi"]}'
                            }
                        ]
                    }
                }
